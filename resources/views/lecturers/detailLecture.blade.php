                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ten_giao_vien" id="name" class="form-control" value="{{ $detail_lecture->ten_giao_vien }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="so_dien_thoai" id="name" class="form-control" value="{{ $detail_lecture->so_dien_thoai }}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="date" name="ngay_sinh" id="name" class="form-control" value="{{ $detail_lecture->ngay_sinh }}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="dia_chi" id="name" class="form-control" value="{{ $detail_lecture->dia_chi }}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="email" name="email" id="name" class="form-control" value="{{ $detail_lecture->email }}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                    </div>
