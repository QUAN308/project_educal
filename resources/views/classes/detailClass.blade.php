                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="ten_lop" id="name" class="form-control" value="{{ $dataDetail->ten_Lop }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="so_luong_hoc_vien" id="" class="form-control" value="{{ $dataDetail->so_luong_hoc_vien }}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <select name="id_khoa_hoc" class="form-control">
                                    @foreach($dataCourse as $key => $val)
                                        @if($dataDetail->id_khoa_hoc == $val->id)
                                            <option selected value="{{ $val->id }}">{{$val->ten_khoa_hoc}}</option>
                                        @else
                            ...
                            <div class="col-md-9 col-sm-8">
                                <select name="id_giao_vien" class="form-control" aria-label="Default select example">
                                    @foreach($dataLect as $key => $val)
                                        @if($dataDetail->id_giao_vien == $val->id)
                                            <option selected value="{{$val->id}}">{{$val->ten_giao_vien}}</option>
                                        @else
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="so_gio_hoc" id="" class="form-control" value="{{$dataDetail->so_gio_hoc}}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                    </div>
