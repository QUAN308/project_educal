                    ...
                    <table class="table table-bordered">
                        ...
                        <!-- $list = $this->v['list'] trong LoadUsers -->
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{route('route_BackEnd_list_user_detail', $item->id)}}" style="white-space:unset;text-align: justify;">{{$item->name}}<i class="fa fa-edit"></i></a></td>
                                <td class="text-center">{{$item->email}}</td>
                                <td class="text-center">nhân viên</td>
                                <td>
                                    <a style="border-radius: 5px;" class="btn btn-danger" href="{{ route('route_BackEnd_list_user_delete', $item->id) }}"><i style="color: #fff;" class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
