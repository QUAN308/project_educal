...
@section('content')
    ...
    <!-- Phần nội dung riêng của action  -->
        <form class="form-horizontal " action="{{ route('route_BackEnd_list_user_update', ['id'=>request()->route('id')]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="text-center">
                ...
                <a href="{{ route('route_BackEnd_list_user_Users') }}" class="btn btn-default">Cancel</a>
            </div>
            <!-- /.box-footer -->
        </form>
